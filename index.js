...
module.exports = function (pkg) {
  ...
  return through.obj(function (file, enc, cb) {
    ...
    deb(files, pkg, function (err, ctrl) {
      ...
      let out = `${pkg._out}/${pkg.package}_${pkg.version}-${pkg.architecture}`
      ...
      fs.outputFile(`${out}/DEBIAN/control`, ctrlf.substr(0, ctrlf.length - 1), function (err) {
        ...
        _exec(`dpkg-deb --build ${pkg._out}/${pkg.package}_${pkg.version}-${pkg.architecture}`, function (err, stdout, stderr) {
